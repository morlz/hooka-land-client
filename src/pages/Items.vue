...
<q-page class="Items">
  <div class="Items__content">
    <item v-for="item in items" :key="item.id" :content="item" />
  </div>

  <div class="flex flex-center">
    <q-pagination class="Items__pages" :value="$route.params.page || 1" :max="pages" :max-pages="6" :boundary-numbers="false" @input="__openPage" />
  </div>
</q-page>
</template>
